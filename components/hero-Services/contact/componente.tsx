...
export function Formulario() {
  return (
    <div className="w-full max-w-6xl mt-16 px-4 mb-16 mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        {/* LEFT */}
        <div className="flex flex-col gap-6">
          {/* Horario */}
          <div className="rounded-2xl p-6 bg-white border border-border shadow-sm dark:bg-white/5">
          ...
          {/* Contacto */}
          <div className="rounded-2xl p-6 bg-[hsl(217,60%,18%)]">
            <div className="flex items-center gap-3 mb-5">
        ...
        {/* RIGHT — Formulario */}
        <div className="rounded-2xl p-8 bg-[hsl(217,60%,18%)] text-white">
          <p className="text-xs text-white/50 uppercase tracking-widest mb-2">
            Formulario de contacto
          </p>
          <h3 className="text-4xl font-bold text-[hsl(207,76%,55%)] mb-2">
            Cuéntanos tu idea
          </h3>
          ...
          <div className="flex flex-col gap-4">
            ...
            <textarea
              rows={4}
              className="rounded-xl px-4 py-3 text-sm bg-white/10 border border-white/15 text-white placeholder:text-white/30 outline-none focus:border-[hsl(207,76%,55%)] transition resize-none"
              placeholder="Cuéntanos sobre tu proyecto..."
            />
            <button className="w-full flex items-center justify-center gap-2 rounded-xl bg-[hsl(207,76%,45%)] py-3.5 text-sm font-semibold text-white hover:bg-[hsl(207,76%,40%)] transition-all">
