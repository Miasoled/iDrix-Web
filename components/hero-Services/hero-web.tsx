    ...
    >
      ...
      {/* Content */}
        ...
        <p className="mb-6 max-w-2xl text-balance text-base leading-relaxed text-[hsl(200,15%,45%)] dark:text-muted-foreground md:text-lg">
            Un equipo de ingenieros apasionados por la tecnología, dedicados a transformar
            sus ideas en experiencias digitales impactantes y funcionales que impulsan el
