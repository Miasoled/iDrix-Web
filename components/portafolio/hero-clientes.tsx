import ClientCards from "./content";
export function HeroClientes() {
  return (
    <section className="relative flex min-h-[100svh] flex-col items-center justify-between overflow-hidden pt-24 pb-0 transition-colors duration-500 md:pt-28 lg:pt-32">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            height: "195px",
            borderRadius: "9999px",
            background: "var(--hero-clientes-glow-2, rgba(107, 215, 255, 0.5))",
            filter: "blur(100px)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "449px",
            borderRadius: "9999px",
            background: "var(--hero-clientes-glow-3, rgba(138, 237, 255, 0.2))",
            filter: "blur(100px)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "449px",
            borderRadius: "9999px",
            background: "var(--hero-clientes-glow-white, rgba(255, 255, 255, 0.5))",
            filter: "blur(10px)",
          }}
        />
        ...
        >
          <defs>
            ...
            >
              <stop offset="91.8275%" style={{ stopColor: "var(--hero-clientes-arc, #d2e7f9)" }} />
              <stop
                offset="100%"
                style={{ stopColor: "var(--hero-clientes-radial-stop, white)" }}
              />
            </linearGradient>
            <linearGradient
              id="grad-arco2"
        ...
        {/* 4. Punto sólido (centrado con flex) */}
      ...
      <div className="flex flex-col mt-8 z-10 text-center">
        <h1 className="text-6xl font-bold text-primary ">Nuestros Clientes</h1>
        <h1 className="text-6xl font-bold light-text-gradient">iDrix Technology</h1>
        <p className="w-2xl mt-7 text-muted-foreground">
          Bienvenido a iDrix Technology S.A, tu socio confiable en el desarrollo de software. Nos
          enorgullece presentarte a nuestros clientes, quienes confían en nosotros para impulsar su
