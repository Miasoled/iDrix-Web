...
export function HeroContacto() {
  return (
    <section
      className="relative flex min-h-[100svh] flex-col items-center overflow-hidden pt-24 pb-16 transition-colors duration-500 md:pt-28 lg:pt-32"
    ...
    >
      ...
      {/* Heading */}
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center px-4 text-center mb-12">
