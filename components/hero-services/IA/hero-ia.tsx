...
export default function HeroIA() {
  ...
  const videoUrl =
    "https://res.cloudinary.com/ddodvvqcq/video/upload/v1746723840/iDrix/IDrixPresentacionIA.mp4";

  return (
    <>
      <section
        className="relative flex flex-col items-center overflow-hidden pt-24 pb-16 px-4 md:px-12 lg:px-10 transition-colors duration-500 md:pt-28 lg:pt-28"
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <button
                ...
                className="group video-button inline-flex items-center justify-center gap-2 rounded-xl bg-white/50 backdrop-blur-sm border border-gray-200 px-6 py-3 text-sm font-medium transition-all hover:bg-gray-50 hover:-translate-y-0.5 !text-black"
              >
