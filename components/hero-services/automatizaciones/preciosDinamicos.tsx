      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 text-xs font-semibold tracking-widest uppercase">
              <TrendingUp className="w-4 h-4" />
              Dynamic Pricing AI
            </div>
            
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tight leading-[1.05] text-[hsl(200,50%,15%)] dark:text-white">
              Precios <br />
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-sm font-semibold text-muted-foreground uppercase tracking-tight">
          ...
          <div className="relative">
            ...
            <div className="bg-card/50 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/20 dark:border-white/10">
              <div className="text-center mb-10">
                ...
                <div className="text-6xl md:text-7xl font-semibold font-mono text-[hsl(207,76%,45%)] flex items-baseline justify-center gap-1 tracking-tighter">
                  +12<span className="text-3xl md:text-4xl">%</span>
                </div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mt-4">Aumento promedio de margen</p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex justify-between items-center p-4 rounded-2xl bg-white/40 dark:bg-white/5 border border-white/20">
                    <span className="text-xs font-semibold text-muted-foreground uppercase tracking-tight">{row.label}</span>
                    <span className={`font-mono font-semibold ${row.type === "plus" ? "text-emerald-500" : ""}`}>{row.val}</span>
                  </div>
                ))}
                ...
                <div className="flex justify-between items-center p-6 rounded-2xl bg-[hsl(207,76%,45%)] text-white shadow-xl shadow-blue-500/20 mt-6 group">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-semibold uppercase tracking-widest opacity-80">Precio Inteligente</span>
                    <span className="text-2xl font-semibold font-mono tracking-tighter">$61.69</span>
                  </div>
